...
@Component({
  selector: 'app-kaspinjaman',
  templateUrl: './kaspinjaman.page.html',
  styleUrls: ['./kaspinjaman.page.scss'],
})
export class KaspinjamanPage implements OnInit {
  ...
  loadNasabah(isFirstLoad, event){
    ...
    this.http.get('https://kspwahyuartasejahtera.co.id/mobileapi/kolektor/kas_pinjaman/' + kolektor + '/' + this.page_limit + '/' + this.page_number)
    .subscribe((data: any ) => {
